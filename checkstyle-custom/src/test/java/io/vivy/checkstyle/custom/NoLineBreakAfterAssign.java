...
public class NoLineBreakAfterAssign {
    ...
    private DefaultConfiguration prepareConfiguration() {
        ...
        DefaultConfiguration parameterFormatting = new DefaultConfiguration(NoLineBreakAfterAssignCheck.class.getCanonicalName());
    ...
    private List<File> prepareFilesToBeChecked() {
        String testFileName = "TestNoLineBreakAfterAssignCheckErrors.java";
