...
public class SingleArgumentLambdaShouldStartOnSame {
    ...
    private com.puppycrawl.tools.checkstyle.DefaultConfiguration prepareConfiguration() {
        DefaultConfiguration checks = new DefaultConfiguration("Checks");
        DefaultConfiguration treeWalker = new DefaultConfiguration("TreeWalker");
        DefaultConfiguration parameterFormatting = new DefaultConfiguration(SingleArgsLambdaSameLineCheck.class.getCanonicalName());
    ...
    private java.util.List<java.io.File> prepareFilesToBeChecked() {
        String testFileName = "TestSingleLambdaArgument.java";
